...
//#define epsilonhb       0.002   // Learning rate for biases of hidden units
#define epsilonw          0.004    // Learning rate for weights
#define epsilonvb         0.005   // Learning rate for biases of visible units
#define epsilonhb         0.001   // Learning rate for biases of hidden units
#define weightcost        0.0001
...
double Aic[NMOVIES][5][NFACTORS];
double Bcj[NFACTORS][TOTAL_FEATURES];
//double vishid[NMOVIES][5][TOTAL_FEATURES];
double visbiases[NMOVIES][5];
double hidbiases[TOTAL_FEATURES];
double Apos[NMOVIES][5][NFACTORS];
double Aneg[NMOVIES][5][NFACTORS];
double Ainc[NMOVIES][5][NFACTORS];
double Bpos[NFACTORS][TOTAL_FEATURES];
double Bneg[NFACTORS][TOTAL_FEATURES];
double Binc[NFACTORS][TOTAL_FEATURES];
...
double Wij(int i, int k, int j) {
	double wsum = 0;
	int c;

	for(c=0; c < NFACTORS; c++)
		wsum += Aic[i][k][c] * Bcj[c][j];
